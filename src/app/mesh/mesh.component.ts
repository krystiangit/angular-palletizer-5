...
*/
  ...
  check() {
    ...
    for (let index = 0; index < this.helpersBoxOfPallet.length; index++) {
      console.log('helpers names: ' + this.helpersBoxOfPallet[index].name);
    }
    for (let index = 0; index < this.helpersBoxOfPp.length; index++) {
